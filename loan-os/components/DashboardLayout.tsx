                          ...
                          <a
                            ...
                            className={classNames(
                              item.current
                                ...
                                : "text-gray-600 hover:bg-neutral-100 hover:text-gray-600",
        ...
        <div className="flex flex-1 flex-col md:pl-59">
          <div className="sticky top-0 z-10 bg-gray-100 pl-1 pt-1 sm:pl-3 sm:pt-3 md:hidden">
            <div className="flex items-center gap-2">
              <button
                type="button"
                className="-ml-0.5 -mt-0.5 inline-flex h-12 w-12 items-center justify-center rounded-md text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-neutral-500"
